...
void tradingDialog::ActionsOnSwitch(int index = -1){
    ...
    switch (index){
                ...
                case 5://show balance tab
                    ...
                    Response = GetBalance("A");
                    if(Response.size() > 0 && Response != "Error"){
                        DisplayBalance(*ui->DVYBalanceLabel,*ui->DVYAvailableLabel_2,*ui->DVYPendingLabel, QString::fromUtf8("A"),Response);
                    }
                break;
...
void tradingDialog::on_Sell_Max_Amount_clicked()
{
    ...
    QString responseA = GetBalance("A");
    QString str;
