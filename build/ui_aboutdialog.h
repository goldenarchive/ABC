...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Advantage", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Advantage</b> version", 0));
...
"Copyright \302\251 2018 The Advantage developers", 0));
