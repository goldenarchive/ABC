...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 A"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 A"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 A"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 A"));
